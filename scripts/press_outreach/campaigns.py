...
# Save a Thunderbird template whose subject contains INDUSTRY_OUTREACH before running.
INDUSTRY = _campaign(
    id="industry",
    label="Industry database outreach",
    subject_marker="INDUSTRY_OUTREACH",
    numbers_filename="2026 Industry Contact List .numbers",
    require_hook_block=False,
    require_sign_off_block=False,
    use_llm_hooks=True,
)

CAMPAIGNS: dict[str, Campaign] = {c.id: c for c in (PRESS, INDUSTRY)}
